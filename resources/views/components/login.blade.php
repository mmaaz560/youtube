...
<x-layout>
    <div class="flex justify-center items-center min-h-screen">
     ...
     class="xl:w-[40%] bg-gray-100 shadow-2xl rounded-xl p-5 lg:w-[60%] md:w-[75%] sm:w-[85%]">
     @csrf
            ...
            <div class="text-center mt-1 ">
              ...
              <div class="mt-1">
                ...
                <input type="text" id="full-name" name="email" placeholder="Enter your email" class="bg-gray-100 border border-gray-300 rounded-sm w-full py-2 px-4 focus:outline-none focus:ring-1 focus:ring-blue-300">
            </div>

            <div class="mt-1">
                <label for="full-name" class="block text-gray-500 font-medium mb-2 ">Password</label>
                <input type="text" id="full-name" name="password"  placeholder="Enter your password" class="bg-gray-100 border border-gray-300 rounded-sm w-full py-2 px-4 focus:outline-none focus:ring-1 focus:ring-blue-300">
            </div>
